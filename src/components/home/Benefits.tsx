        ...
        <section id="nosotros" aria-labelledby="benefits-title" className="relative scroll-mt-28 bg-[#243054] px-6 py-20" >
            <div className="mx-auto max-w-6xl">
                <div className="mx-auto max-w-2xl text-center">
                    <span className="nunito text-sm font-semibold uppercase tracking-widest text-white/50 selection:text-white selection:bg-[#243054]">
                        Ventajas
                    </span>
                    ...
                    <p className="nunito text-sm text-gray-400 selection:text-white selection:bg-[#243054]">
