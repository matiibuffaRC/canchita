...
export default function Benefits() {
  return (
    <section
      ...
      className="relative scroll-mt-28 bg-[#243054] px-6 py-20"
    >
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2
            id="benefits-title"
            className="nunito mt-3 text-3xl font-bold text-white md:text-4xl"
          >
            ¿Por qué elegirnos?
          </h2>

          <p className="nunito text-sm text-gray-400">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit, index) => (
            <Reveal
              key={benefit.title}
              delay={index * 0.1}
              className="nunito rounded-xl border border-white/10 bg-white/2 p-7 transition duration-300 hover:-translate-y-1 hover:bg-white/6"
            >
