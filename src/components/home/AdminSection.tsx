    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-12 md:flex-row md:justify-between">
        <div className="max-w-xl text-center md:text-start">
          ...
          <h2
            id="admin-title"
            className="nunito mt-3 text-3xl font-bold md:text-4xl selection:text-gray-400 selection:bg-bg-white/6"
          >
          ...
          <Link
            href="/admin"
            className="nunito font-bold mt-6 inline-block rounded-4xl bg-white px-7 py-3.5 text-sm text-[#243054] shadow-lg shadow-black/10 transition-all duration-300 hover:-rotate-2 hover:bg-white/90 motion-reduce:transition-none motion-reduce:hover:translate-y-0 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-white"
          >
        ...
        <div className="flex w-full max-w-sm flex-col gap-4">
          {perks.map((perk) => (
            <div
              key={perk.text}
              className="nunito flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm hover:translate-x-2 transition-all duration-300 selection:text-white selection:bg-bg-white/6"
            >
