    ...
    <div className="mt-12 grid gap-6 md:grid-cols-3">
      {steps.map((step, index) => (
        <Reveal
          key={step.number}
          delay={index * 0.1}
          className="nunito rounded-xl border border-[#243054]/10 bg-[#243054]/5 p-7 backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:bg-white/10 hover:cursor-pointer"
        >
          ...
          <p className="mt-1 leading-7 text-[#243054]/70">{step.description}</p>
        </Reveal>
      ))}
    </div>
  );
