      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="group relative w-full max-w-sm sm:max-w-md md:max-w-2xl">
            ...
            <div
              aria-hidden="true"
              className="absolute -inset-5 rotate-2 md:rotate-0 md:group-hover:rotate-2 transition-all duration-500 rounded-4xl bg-white/10 p-5"
            />
                ...
                >
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div className="flex flex-col gap-2">
                      <label
                        htmlFor="name"
                        className="cursor-pointer text-xs font-bold uppercase tracking-widest text-[#243054]/50"
                      >
                        Nombre
                      </label>
                      <input
