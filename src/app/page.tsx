...
export default function Home() {
  return (
    <>
      ...
      <main
        id="inicio"
        className="min-h-screen overflow-hidden bg-white text-[#243054]"
      >
        <ScrollProgress
          sections={[
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-6xl border-t border-[#243054]/10 pt-5">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2
                id="steps-title"
                className="nunito mt-3 text-3xl font-bold md:text-4xl selection:bg-white/10 selection:text-black"
              >
